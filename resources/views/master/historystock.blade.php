...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="/pegawai/pendataan">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="/pegawai/pemesanan">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="/pegawai/penerimaan">
                    <i class="fas fa-fw fa-table"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    @endif
                    <div class="col-6">
                        <h1>Data History Stock</h1>
                    </div>
                    <p><a href="/insert_history_stock"<button type="button" class="btn btn-primary float-right">
                        Tambah Data History Stock</button></a></p>
                    <br>
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th scope="col">Tanggal History Stock</th>
