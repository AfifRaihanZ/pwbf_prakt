            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tabel Data Transaksi :</h6>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                ...
                                <div class="modal-body">
                                    <form action="/jenisbarang/create" method="POST">
                                        <div class="form-group">
                                          ...
                                          <input name="id_trima" type="text" class="form-control" id="exampleInputIDTrima" placeholder="Masukkan ID Trima">
                                        </div>
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input name="tanggal_trima" type="text" class="form-control" id="exampleInputTanggalTrima" placeholder="Masukkan Tanggal Trima">
                                          </div>
                                          <div class="form-group">
                                            <label for="exampleInputTotalHarga">Total Harga</label>
                                            <input name="total_harga" type="number" class="form-control" id="exampleInputTotalHarga" placeholder="Masukkan Total Harga">
                                          </div>
                                        <div class="form-group">
                                          <label for="exampleInputNamaUser">Status Trima</label>
                                          <input name="status_trima" type="text" class="form-control" id="exampleInputStatusTrima" placeholder="Masukkan Status Trima">
                                        </div>
                                </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                        <tr>
                            <th scope="col">ID Trima</th>
                            <th scope="col">ID Supplier</th>
                            <th scope="col">ID User</th>
                            <th scope="col">Tanggal Trima</th>
                            <th scope="col">Total Harga</th>
                            <th scope="col">Status Trima</th>
