                                ...
                                <div class="modal-body">
                                    <form action="/jenisbarang/create" method="POST">
                                        <div class="form-group">
                                          <label for="exampleInputIDPesan">ID Pesan</label>
                                          <input name="id_pesan" type="text" class="form-control" id="exampleInputIDPesan" placeholder="Masukkan ID Pesan">
                                        </div>
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <label for="exampleInputTanggalPesan">Tanggal Pesan</label>
                                            <input name="tanggal_pesan" type="text" class="form-control" id="exampleInputIDUser" placeholder="Masukkan Tanggal Pesan">
                                          </div>
                                        <div class="form-group">
                                          <label for="exampleInputNamaUser">Status Pesan</label>
                                          <input name="nama_user" type="text" class="form-control" id="exampleInputNamaUser" placeholder="Masukkan Nama User">
                                        </div>
                                </div>
