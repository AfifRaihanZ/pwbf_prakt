                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="/user/create" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Alamat User</label>
                                            <textarea name="alamat_user" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                          </div>
                                        <div class="form-group">
                                            <label for="exampleInputTelpUser">Telp User</label>
                                            <input name="telp_user" type="text" class="form-control" id="exampleInputTelpUser" placeholder="Masukkan Telp User">
                                          </div>
                                          <div class="form-group">
                                            <label for="exampleInputUsername">Username</label>
                                            <input name="username" type="text" class="form-control" id="exampleInputUsername" placeholder="Masukkan Username">
                                          </div>
                                          <div class="form-group">
