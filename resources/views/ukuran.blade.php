                    ...
                    <div class="col-6">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <h5 class="modal-title" id="exampleModalLabel">Input Data Ukuran</h5>
                                ...
                                <div class="modal-body">
                                    <form action="/jenisbarang/create" method="POST">
                                        <div class="form-group">
                                          <label for="exampleInputIDUser">ID Ukuran</label>
                                          <input name="id_user" type="text" class="form-control" id="exampleInputIDUser" placeholder="Masukkan ID Ukuran">
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputNamaUser">Ukuran</label>
                                          <input name="nama_user" type="text" class="form-control" id="exampleInputNamaUser" placeholder="Masukkan Ukuran">
                                        </div>
                                </div>
