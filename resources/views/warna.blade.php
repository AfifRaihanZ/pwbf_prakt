                                ...
                                <div class="modal-body">
                                    <form action="/jenisbarang/create" method="POST">
                                        <div class="form-group">
                                          <label for="exampleInputIDUser">ID Warna</label>
                                          <input name="id_user" type="text" class="form-control" id="exampleInputIDUser" placeholder="Masukkan ID Warna">
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputNamaUser">Warna</label>
                                          <input name="nama_user" type="text" class="form-control" id="exampleInputNamaUser" placeholder="Masukkan Warna">
                                        </div>
                                </div>
